...
$p = 1
  ...
  def calculation arr
    ...
    case arr[0].to_f
    when 1 then return arr[1].to_f + arr[2].to_f
    when 2 then return arr[1].to_f - arr[2].to_f
    when 3 then return arr[1].to_f * arr[2].to_f
    when 4 then return arr[1].to_f / arr[2].to_f
    when q then $p = 0
    else
      puts "Введіть код існуючої команди!"
    end
  end
